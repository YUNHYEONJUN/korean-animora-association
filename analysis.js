...
// 30개 동물 데이터 (아니모라 공식 블로그 기준)
const animals = {
    1: { name: '표범', emoji: '🐆', type: '상' },
    2: { name: '야생토끼', emoji: '🐰', type: '상' },
    3: { name: '용', emoji: '🐉', type: '상' },
    4: { name: '아나콘다', emoji: '🐍', type: '상' },
    5: { name: '야생마', emoji: '🐴', type: '상' },
    6: { name: '양', emoji: '🐑', type: '중' },
    7: { name: '원숭이', emoji: '🐵', type: '상' },
    8: { name: '독수리', emoji: '🦅', type: '상' },
    9: { name: '들개', emoji: '🐕', type: '중' },
    10: { name: '코끼리', emoji: '🐘', type: '상' },
    11: { name: '호랑이', emoji: '🐯', type: '중' },
    12: { name: '토끼', emoji: '🐰', type: '중' },
    13: { name: '용', emoji: '🐉', type: '중' },
    14: { name: '구렁이', emoji: '🐍', type: '중' },
    15: { name: '말', emoji: '🐴', type: '중' },
    16: { name: '산양', emoji: '🐐', type: '중' },
    17: { name: '침팬지', emoji: '🦍', type: '중' },
    18: { name: '매', emoji: '🦅', type: '중' },
    19: { name: '늑대', emoji: '🐺', type: '상' },
    20: { name: '하마', emoji: '🦛', type: '중' },
    21: { name: '고양이', emoji: '🐱', type: '하' },
    22: { name: '집토끼', emoji: '🐰', type: '하' },
    23: { name: '도롱뇽', emoji: '🦎', type: '하' },
    24: { name: '꽃뱀', emoji: '🐍', type: '하' },
    25: { name: '명품마', emoji: '🐴', type: '하' },
    26: { name: '염소', emoji: '🐐', type: '하' },
    27: { name: '침팬지', emoji: '🦍', type: '하' },
    28: { name: '까마귀', emoji: '🦅', type: '하' },
    29: { name: '강아지', emoji: '🐕', type: '하' },
    30: { name: '코뿔소', emoji: '🦏', type: '하' }
};
